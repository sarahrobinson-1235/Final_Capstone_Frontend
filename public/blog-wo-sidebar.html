                  ...
                  <div class="col-md-12">
                     <div class="row">
                        ...
                        <article id="01" class="post-block col-md-12 post hentry">
                           ...
                           <div class="img-wrap">
                              <a href="blog-post.html">
                                 <img class="img-responsive" src="assets/custom/images/demo01/10.jpg" alt="">
                              </a>
                           </div>
                        ...
                        <article id="03" class="post-block col-md-12 post hentry">
                           ...
                           <div class="img-wrap">
                              <div class="embed-responsive embed-responsive-16by9">
                                 <iframe src="https://player.vimeo.com/video/134300640?color=ffffff&byline=0&portrait=0" width="640" height="268" allowfullscreen></iframe>
                              </div>
                           </div>
                           <div class="post-excerpt">
                        ...
                        <article id="04" class="post-block col-md-12 post hentry">
                           ...
                           <div class="img-wrap">
                              <a href="blog-post.html">
                                 <img class="img-responsive" src="assets/custom/images/demo01/03.jpg" alt="">
                              </a>
                           </div>
                           <blockquote>
                        ...
                        <article id="08" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">15 Places To Get That Holiday Trip Tan</a></h2> <!-- Post Title-->
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">29 July</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">admin</a>/&nbsp;
                                 <a href="#!" class="meta-comment">0 Comment</a>
                        ...
                        <article id="09" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">5 Tips for Successful Whale Watching</a></h2>
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">29 July</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">admin</a>/&nbsp;
                                 <a href="#!" class="meta-comment">0 Comment</a>
                        ...
                        <article id="10" class="post-block col-md-12 post hentry">
                           ...
                           <div class="img-wrap"><a href="blog-post.html"><img class="img-responsive" src="assets/custom/images/demo01/11.jpg" alt=""></a></div>
                           <div class="post-excerpt">
