               ...
               <div class="owl-carousel owl-theme">
                     ...
                     <div class="feat-post text-center">
                        <div class="feat-wrapper">
                           <div class="feat-metas">
                              ...
                              <a href="#!" class="meta-date">29 July</a>in <a href="#!" class="meta-cat">Blogging</a>
                              <h2 class="font-accident-two-normal text-nowrap">Elegant, Simple & Awesome Blog</h2>
                              <div><a href="#!" class="morelink">read more</a></div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="item">
                      <div class="feat-post text-center">
                          <div class="feat-wrapper">
                              <div class="feat-metas">
                                  <div class="ornament-divider-fullwidth"><i class="flaticon-art-17"></i></div>
                                  <a href="#!" class="meta-date">29 July</a>in <a href="#!" class="meta-cat">Blogging / Leadership</a>
                                  <h2 class="font-accident-two-normal text-nowrap">Vimeo Post with auto get thumbnail</h2>
                                  <div><a href="#!" class="morelink">read more</a></div>
                              </div>
                          </div>
                      </div>
                      <img src="assets/custom/images/backgrounds/04.jpg" class="img-responsive" alt="01">
                  </div>
                  ...
                  <div class="item">
                      <div class="feat-post text-center">
                          <div class="feat-wrapper">
                              <div class="feat-metas">
                                  <div class="ornament-divider-fullwidth"><i class="flaticon-ornamental-floral-design"></i></div>
                                  <a href="#!" class="meta-date">29 July</a>in <a href="#!" class="meta-cat">Holidays</a>
                                  <h2 class="font-accident-two-normal text-nowrap">This is a SoundCloud Post</h2>
                                  <div><a href="#!" class="morelink">read more</a></div>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="item">
                      <div class="feat-post text-center">
                          <div class="feat-wrapper">
                              <div class="feat-metas">
                                  <div class="ornament-divider-fullwidth"><i class="flaticon-two-3"></i></div>
                                  <a href="#!" class="meta-date">29 July</a>in <a href="#!" class="meta-cat">Uncategorized</a>
                                  <h2 class="font-accident-two-normal text-nowrap">Greece hotel holiday luxury house</h2>
                                  <div><a href="#!" class="morelink">read more</a></div>
                              </div>
                          </div>
                      </div>
                     ...
                     <div class="row">
                        ...
                        <article id="01" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">Elegant, Simple &amp; Awesome Blog Made With Passion</a></h2>
                              <div class="metas">
                           ...
                           <div class="img-wrap">
                              <a href="blog-post.html"><img class="img-responsive" src="assets/custom/images/demo01/10.jpg" alt=""></a>
                           </div>
                           <div class="post-excerpt">
                              <p>Donec at condimentum ligula. Morbi consectetur, nisi nec tincidunt sollicitudin, leo enim fermentum ex, ac varius libero tellus vitae ex. Praesent faucibus vehicula nisi, sed tempus purus feugiat eu. Cras tempor risus eget diam dapibus consequat. Curabitur congue urna nibh, eget sollicitudin eros tristique id. Nunc non vestibulum leo ...</p>
                           </div>
                           <div class="">
                              <a href="blog-post.html" class="btn btn-default tf-btn txt-link btn-rose-str">Continue reading...</a>
                           </div>
                        </article>
                        ...
                        <article id="02" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">This is a Slider for Gallery Post Type – Enjoy Browsing Your Beautiful Photos</a></h2>
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">29 July</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">admin</a>/&nbsp;
                                 <a href="#!" class="meta-comment">0 Comment</a>
                           ...
                           <div class="img-wrap">
                              <div class="owl-carousel owl-theme">
                                 <div class="item"><img class="img-responsive" src="assets/custom/images/demo01/09.jpg" alt=""></div>
                                 <div class="item"><img class="img-responsive" src="assets/custom/images/demo01/11.jpg" alt=""></div>
                                 <div class="item"><img class="img-responsive" src="assets/custom/images/demo01/03.jpg" alt=""></div>
                                 <div class="item"><img class="img-responsive" src="assets/custom/images/demo01/01.jpg" alt=""></div>
                              </div>
                           </div>
                           <div class="post-excerpt">
                        ...
                        <article id="03" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">Vimeo Post with auto get thumbnail</a></h2>
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">29 July</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">admin</a>/&nbsp;
                                 <a href="#!" class="meta-comment">0 Comment</a>
                           ...
                           <div class="img-wrap">
                              <div class="embed-responsive embed-responsive-16by9">
                                 <iframe src="https://player.vimeo.com/video/134300640?color=ffffff&byline=0&portrait=0" width="640" height="268"></iframe>
                              </div>
                           </div>
                           <div class="post-excerpt">
                              <p>The Mini (marque), which includes a number of different models produced by BMW since 2000. A number of different models have cars with the "Mini Cooper" title, including the Mini Hatch, the Mini Convertible, the Mini Clubman, the Mini Countryman, the Mini Coupé, the Mini Roadster, and the Mini Paceman…</p>
                           </div>
                           <div class="">
                              <a href="blog-post.html" class="btn btn-default tf-btn txt-link btn-rose-str">Continue reading...</a>
                           </div>
                        ...
                        <article id="04" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">This is a Quote Post</a></h2>
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">29 July</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">admin</a>/&nbsp;
                                 <a href="#!" class="meta-comment">0 Comment</a>
                           ...
                           <div class="img-wrap">
                              <a href="blog-post.html">
                                 <img class="img-responsive" src="assets/custom/images/demo01/11.jpg" alt="">
                              </a>
                           </div>
                        ...
                        <article id="05" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">This is Video Post Using Youtube Embed Codes</a></h2>
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">29 July</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">admin</a>/&nbsp;
                                 <a href="#!" class="meta-comment">0 Comment</a>
                           ...
                           <div class="img-wrap">
                              <div class="embed-responsive embed-responsive-16by9">
                                 <iframe width="560" height="315" src="https://www.youtube.com/embed/T0q-KnaheFE?rel=0&amp;controls=0&amp;showinfo=0" allowfullscreen></iframe>
                              </div>
                           </div>
                           <div class="post-excerpt">
                        ...
                        <article id="06" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">This is a SoundCloud Post</a></h2>
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">29 July</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">admin</a>/&nbsp;
                                 <a href="#!" class="meta-comment">0 Comment</a>
                           ...
                           <div class="img-wrap">
                              <iframe width="560" height="166" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/249027617&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
                           </div>
                           <div class="post-excerpt">
                        ...
                        <article id="07" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">Greece Vacation in August</a></h2>
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">29 July</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">admin</a>/&nbsp;
                                 <a href="#!" class="meta-comment">0 Comment</a>
                           ...
                           <div class="img-wrap"><a href="blog-post.html"><img class="img-responsive" src="assets/custom/images/demo01/03.jpg" alt=""></a></div>
                           <div class="post-excerpt">
                        ...
                        <article id="08" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">10 Places for a Perfect Vacation</a></h2> <!-- Post Title-->
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">29 July</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">admin</a>/&nbsp;
                                 <a href="#!" class="meta-comment">0 Comment</a>
                           ...
                           <div class="img-wrap"><a href="blog-post.html"><img class="img-responsive" src="assets/custom/images/demo01/08.jpg" alt=""></a></div>
                           <div class="post-excerpt">
                        ...
                        <article id="09" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">5 Tips for Successful <strong>Bird Watching</strong></a></h2>
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">29 July</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">admin</a>/&nbsp;
                                 <a href="#!" class="meta-comment">0 Comment</a>
                           ...
                           <div class="img-wrap"><a href="blog-post.html"><img class="img-responsive" src="assets/custom/images/demo01/05.jpg" alt=""></a></div>
                           <div class="post-excerpt">
                        ...
                        <article id="10" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              ...
                              <h2 class="entry-title"><a href="blog-post.html">Emma is an Elegant, Simple &amp; Minimalist Blog comes with Lots of Features</a></h2>
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">29 July</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">admin</a>/&nbsp;
                                 <a href="#!" class="meta-comment">0 Comment</a>
                           ...
                           <div class="img-wrap"><a href="blog-post.html"><img class="img-responsive" src="assets/custom/images/demo01/01.jpg" alt=""></a></div>
                           <div class="post-excerpt">
